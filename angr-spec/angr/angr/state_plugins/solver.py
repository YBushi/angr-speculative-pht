...
class SimSolver(SimStatePlugin):
    ...
    def __getattr__(self, a):
        ...
        if hasattr(f, '__call__'):
            ...
            # if _timing_enabled and a != 'BVV' and a != 'Concat':
...
#    @timed_function
    ...
    def max(self, e, extra_constraints=(), exact=None):
        ...
        """
        # mwi: we don't use VALIDATE_APPROXIMATIONS
...
#    @timed_function
# mwi: we don't set CONSTRAINT_TRACKING_IN_SOLVER -> unused for our purposes
    @ast_stripping_decorator
    @error_converter
...
#    @timed_function
# mwi: we don't count adding constraints as solver invocation
    @ast_stripping_decorator
    @error_converter
...
#    @timed_function
# mwi: calls only eval_upto -> no need to time it
    @ast_stripping_decorator
